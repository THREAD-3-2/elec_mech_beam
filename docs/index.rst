...
the `Institute of Applied Dynamics <https://www.ltd.tf.fau.de/>`_, FAU. 
...
applied as shown in :ref:`Variational integrator <vi>`. The code can be run from the main file at `src/main.m`.
